...
public struct Provider: TimelineProvider {
    ...
    private let userDefaults: UserDefaults? = UserDefaults(suiteName: "\(Bundle.main.object(forInfoDictionaryKey: "TeamId") as! String).com.mydoghatestechnology.Stats.widgets")
