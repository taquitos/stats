...
class SettingsWindow: NSWindow, NSWindowDelegate, NSToolbarDelegate {
    ...
    private static let frameAutosaveName = "com.mydoghatestechnology.Stats.Settings.WindowFrame"
    ...
    init() {
        ...
        let newToolbar = NSToolbar(identifier: "com.mydoghatestechnology.Stats.Settings.Toolbar")
